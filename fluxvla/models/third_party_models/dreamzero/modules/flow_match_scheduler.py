...
#
# Origin: Source
# Upstream-URL: https://github.com/dreamzero0/dreamzero/blob/main/groot/vla/model/dreamzero/modules/flow_match_scheduler.py
# Upstream-Ref: main
    ...
    def training_weight(self, timestep):
        ...
        timestep_id = torch.argmin(
            (self.timesteps.unsqueeze(1) -
             timestep.unsqueeze(0).to(self.timesteps.device)).abs(),
            dim=0)
