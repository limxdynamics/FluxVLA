...
def main() -> None:
    parser = argparse.ArgumentParser(description="Parse sparse subtask info per episode.")
    parser.add_argument(
        "--dataset-root",
        type=Path,
        required=True,
        help="Dataset root directory containing meta/episodes and meta/temporal_proportions_sparse.json",
    )
    parser.add_argument(
        "--output",
        type=Path,
    ...
    for _, row in episodes_df.iterrows():
        ...
        temporal_props = _compute_temporal_proportions(sparse_names, sparse_starts, sparse_ends)
    ...
    output_path = args.output or (args.dataset_root / "sparse_episode_info.json")
