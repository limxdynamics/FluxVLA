...
@unittest.skipUnless(
    torch.cuda.is_available() and os.path.exists(XVLA_RESOURCE_PATH) and os.path.exists(XVLA_PRETRAINED_PATH),
    f'CUDA not available or checkpoint not found: {XVLA_RESOURCE_PATH} or {XVLA_PRETRAINED_PATH}')
