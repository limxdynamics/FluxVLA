...
_LEROBOT_ROOT = './datasets/libero_4suite_xvla_lerobotv2'
...
def _libero_lerobot_dataset(suite_name):
    return dict(
        type='LiberoLeRobotEE6DDataset',
        data_root_path=f'{_LEROBOT_ROOT}/{suite_name}',
        num_actions=30,
        num_views=3,
        embodiment_id=3,
        training=True,
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        statistic_name='private',
        datasets=[
            _libero_lerobot_dataset('libero_10'),
            _libero_lerobot_dataset('libero_goal'),
            _libero_lerobot_dataset('libero_object'),
            _libero_lerobot_dataset('libero_spatial'),
        ],
    ),
)
