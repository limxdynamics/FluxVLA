...
LeRobot v3.x の SARM データセットを学習や公開に使う前に、動画メタデータを確認してください:
...
- ディレクトリ内に複数の MP4 があるのに、すべての episode が `file-000.mp4` を指している場合、その metadata は壊れているため、学習や Hugging Face への公開前に修正してください。
